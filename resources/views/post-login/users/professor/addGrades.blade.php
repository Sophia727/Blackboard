    ...
    <div class="modal fade" id="addGradesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="col-4">
        <div class="row">
            ...
            <div class="col-6">
              <button data-toggle="modal" data-target="#addGradesModal" title="writePost" data-bs-placement="right" class="btn btn-outline-secondary"><i class="fa-solid fa-upload"></i> Import Grades</button>
            </div>
        </div>
